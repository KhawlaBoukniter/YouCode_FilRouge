...
export default function Sidebar() {
    return (
        <aside className="w-fit fixed top-0 left-0 h-screen md:w-72 bg-gradient-to-b from-[#f8f7f4] to-[#f0efea] l-6 py-10 md:pl-8 pl-0 rounded-tr-[80px] z-50 shadow-sm">

            <p
                className="text-2xl hidden md:inline font-playfair font-semibold px-2 mb-8 tracking-wide bg-gradient-to-r from-[#d3bb75] via-[#3a6b8f] to-[#d3bb75] bg-clip-text text-transparent"
            >
